...
# Listen für die Grafik vorbereiten
...
# Markierung, wo das beste Modell gespeichert wurde (vor der Patience)
...
plt.title('Probabilistische Photovoltaik-Vorhersage (Multivariat)')
plt.ylabel('MWh')
plt.legend()
plt.show()
...
for i, col in enumerate(feature_cols):
    ...
    # Shuffeln einer einzelnen Spalte innerhalb der Test-Sequenzen
    ...
    with torch.no_grad():
        ...
        # Wie stark steigt der Fehler, wenn dieses Feature "kaputt" ist?
